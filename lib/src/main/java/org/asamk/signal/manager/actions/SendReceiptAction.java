...
public class SendReceiptAction implements HandleAction {
    ...
    public SendReceiptAction(final RecipientId recipientId, final SignalServiceReceiptMessage.Type type,
    ...
    public void mergeOther(final HandleAction action) {
        if (action instanceof SendReceiptAction) {
            this.timestamps.addAll(((SendReceiptAction) action).timestamps);
        }
    }
